...
def main():
    ...
    nome_do_arquivo = os.path.join("Com paralelismo", "1 M", "numeros_aleatorios_0_a_1M.txt")
    
    # Sorteio de um número aleatório entre 0 e 1 Milhão
    numero_buscado = random.randint(0, 1000000)
