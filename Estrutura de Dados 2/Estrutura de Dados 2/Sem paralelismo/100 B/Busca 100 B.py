...
def main():
    ...
    nome_do_arquivo = os.path.join("Com paralelismo", "100 B", "numeros_aleatorios_0_a_100B.txt")
    
    # Sorteio de um número aleatório entre 0 e 100 bilhão
    numero_buscado = random.randint(0, 100000000000)
    ...
    num_workers = 1  # Utilizando múltiplos núcleos
