...
def main():
    ...
    nome_do_arquivo = 'numeros_aleatorios_0_a_100B.txt'
    
    # Remove o arquivo anterior se existir, para começar um novo
    if os.path.exists(nome_do_arquivo):
        os.remove(nome_do_arquivo)
    
    total_numeros = 100000000000  # 100 bilhão de números
    valor_maximo  = 100000000000  # Máximo valor para números aleatórios
    num_workers = 25  # Usar metade dos núcleos do processador
