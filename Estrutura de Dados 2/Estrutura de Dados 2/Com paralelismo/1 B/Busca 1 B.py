...
def main():
    ...
    nome_do_arquivo = os.path.join("Com paralelismo", "1 B", "numeros_aleatorios_0_a_1B.txt")
    
    # Sorteio de um número aleatório entre 0 e 1 bilhão
    numero_buscado = random.randint(0, 1000000000)
    ...
    num_workers = 5  # Utilizando múltiplos núcleos
