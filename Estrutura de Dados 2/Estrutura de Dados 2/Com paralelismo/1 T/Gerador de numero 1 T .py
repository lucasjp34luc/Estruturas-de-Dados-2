...
def main():
    ...
    nome_do_arquivo = 'numeros_aleatorios_0_a_1T.txt'
    
    # Remove o arquivo anterior se existir, para começar um novo
    if os.path.exists(nome_do_arquivo):
        os.remove(nome_do_arquivo)
    
    total_numeros = 1000000000000  # 1 Trilhão de números
    valor_maximo  = 1000000000000  # Máximo valor para números aleatórios
